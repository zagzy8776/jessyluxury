    ...
    <main className="bg-[var(--bg-primary)] text-[var(--text-primary)] min-h-[70vh]">
      <section className="relative overflow-hidden border-b border-[var(--border)] bg-[var(--card-bg)]">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-16 text-center lg:px-8 lg:py-20">
          ...
          <h1 className="mt-3 font-display text-5xl font-bold text-[var(--text-primary)] sm:text-6xl">Privacy Policy</h1>
      ...
      <section className="mx-auto max-w-4xl px-6 py-14 lg:px-8 text-[var(--text-secondary)] text-sm leading-7 space-y-6 font-medium">
        <div>
          <h2 className="font-display text-2xl font-bold text-[var(--text-primary)] mb-2">1. Information We Collect</h2>
          <p>
        ...
        <div>
          <h2 className="font-display text-2xl font-bold text-[var(--text-primary)] mb-2">2. How We Use Your Data</h2>
          <p>
        ...
        <div>
          <h2 className="font-display text-2xl font-bold text-[var(--text-primary)] mb-2">3. Payment &amp; Security</h2>
          <p>
        ...
        <div>
          <h2 className="font-display text-2xl font-bold text-[var(--text-primary)] mb-2">4. Contact Us</h2>
          <p>
