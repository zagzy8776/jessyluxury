  ...
  return (
    <article className="group">
      <div className="relative overflow-hidden rounded-2xl bg-stone-900 shadow-card">
        <div className="relative flex aspect-[4/5] items-center justify-center bg-gradient-to-b from-stone-800 to-stone-950">
      ...
      <div className="pt-4">
        ...
        <h3 className="mt-1 font-display text-lg text-stone-100">{p.name}</h3>
